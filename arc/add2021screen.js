...
module.exports.run = async (client, message, args) => {
    ...
    if(message.member.roles.cache.has(oldRole) || message.member.roles.cache.has(midRole) || message.author.id === "312734500880646145") {
...
module.exports.help = {
    name: "add2021screenshot",
    aliases: ['2021screenshotadd']
}